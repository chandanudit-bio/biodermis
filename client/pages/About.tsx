        ...
        <div className="relative max-w-[1366px] mx-auto px-4 lg:px-[75px]">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="font-lufga text-[15px] lg:text-[16px] text-[#666666] leading-[26px]">
              Founded on the belief that nature holds the key to radiant skin,
              we've spent over 15 years perfecting the art of natural skincare.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mt-16 lg:mt-20">
            ...
            <div className="bg-white rounded-[24px] p-8 text-center shadow-[0_2px_8px_rgba(0,0,0,0.08)]">
              <h3 className="font-lufga text-[36px] lg:text-[42px] text-[#8B1C52] font-bold mb-2">
                50K+
              </h3>
              <p className="font-lufga text-[13px] lg:text-[14px] text-[#666666] font-medium">
                Happy Customers
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-8 right-0 lg:right-[-50px] bg-[#8B1C52] text-white rounded-[20px] px-6 py-4 shadow-[0_8px_24px_rgba(139,28,82,0.3)] flex items-center gap-3 max-w-xs">
                ...
                <span className="font-lufga text-[15px] font-semibold">
            ...
            <div>
              <h2 className="font-regals text-[28px] lg:text-[32px] leading-[1.3] mb-8 text-black font-bold">
                Our Mission: Pure, Effective,
                <br />
                Honest Skincare
              </h2>

              <p className="font-lufga text-[15px] text-[#666666] leading-[26px] mb-6 font-normal">
                At Biodermis, we believe that the most powerful skincare
                solutions come from nature itself. Our mission is to harness the
                incredible healing properties of plants and botanicals, backed
                by rigorous scientific research.
              </p>

              <p className="font-lufga text-[15px] text-[#666666] leading-[26px] mb-10 font-normal">
                Every ingredient we choose is selected for its proven benefits
                and safety profile. We never compromise on quality, and we're
                completely transparent about what goes into every bottle.
              </p>
        ...
        <div className="max-w-[1366px] mx-auto px-4 lg:px-[75px]">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 lg:mb-20">
            ...
            <p className="font-lufga text-[15px] text-[#666666] leading-[26px] font-normal">
              Our commitment to excellence goes beyond just creating great
              products. It's about building trust, ensuring safety, and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-[24px] p-10 shadow-[0_2px_8px_rgba(0,0,0,0.06)] text-center">
              ...
              <h3 className="font-lufga text-[18px] mb-4 text-black font-bold">
                100% Natural
              </h3>
            ...
            <div className="bg-white rounded-[24px] p-10 shadow-[0_2px_8px_rgba(0,0,0,0.06)] text-center">
              ...
              <p className="font-lufga text-[14px] text-[#666666] leading-[22px] font-normal">
                Gentle formulas tested for all skin types with zero harsh
                chemicals
              </p>
            </div>
