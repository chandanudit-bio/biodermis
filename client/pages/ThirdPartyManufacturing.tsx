  ...
  const benefits = [
    {
      ...
      description:
        "Comprehensive pharmaceutical contract manufacturing services with complete quality assurance",
    },
    {
      icon: "✓",
      title: "Single-Window Solution",
      description:
        "One-stop solution for all your third-party manufacturing needs and requirements",
    },
    {
      icon: "✓",
      title: "PCD Pharma Services",
      description:
        "Help you establish your own PCD pharma company with our expertise",
    },
    {
      icon: "✓",
        ...
        <div className="relative max-w-[1366px] mx-auto px-4 lg:px-[75px]">
          <div className="text-center">
            ...
            <p className="font-lufga text-[16px] lg:text-[18px] text-[#666666] max-w-3xl mx-auto">
              Biodermis Pharma is your trusted partner for comprehensive
              pharmaceutical contract manufacturing with ISO & GMP certified
              facilities and 500+ products
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1366px] mx-auto px-4 lg:px-[75px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-[#FDECEF] rounded-[15px] p-6 lg:p-8 text-center"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="font-regals text-[32px] lg:text-[42px] leading-[1.3] text-black mb-6">
                Why Choose{" "}
                <span className="text-[#8B1C52]">Biodermis Pharma?</span>
              </h2>

              <div className="space-y-4">
                <p className="font-lufga text-[14px] lg:text-[15px] text-[#333333] leading-relaxed">
                  Biodermis Pharma stands as the greatest alternative for
                  third-party production with wide knowledge and experience in
                  the pharmaceutical field. We have established strong goodwill
                  in third-party pharmaceutical manufacturing.
                </p>

                <p className="font-lufga text-[14px] lg:text-[15px] text-[#333333] leading-relaxed">
                  Our commitment to excellence and quick turnaround time of
                  fewer than 30 days makes us the ideal choice for companies
                  seeking a reliable third-party manufacturing partner.
                </p>

                <p className="font-lufga text-[14px] lg:text-[15px] text-[#333333] leading-relaxed">
                  We understand that pharmaceutical manufacturing requires
                  ongoing effort, master knowledge, and a dedicated approach.
                  Our team has demonstrated the expertise to generate incredible
                  results in the pharma industry.
                </p>
              </div>
            ...
            <div className="hidden lg:block">
              <div className="bg-gradient-to-br from-[#FDECEF] to-[#f5d7e1] rounded-[20px] p-12 flex items-center justify-center min-h-[400px]">
                <div className="text-center">
                  ...
                  <p className="font-lufga text-[14px] text-[#666666]">
        ...
        <div className="max-w-[1366px] mx-auto px-4 lg:px-[75px]">
          <div className="text-center mb-16">
            ...
            <p className="font-lufga text-[14px] lg:text-[15px] text-[#666666] max-w-2xl mx-auto">
              Comprehensive solutions for all your third-party manufacturing
              needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="flex gap-6 p-6 lg:p-8 bg-gray-50 rounded-[15px] hover:shadow-lg transition-shadow duration-300"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div>
                ...
                <p className="font-lufga text-[13px] lg:text-[14px] text-[#666666] leading-relaxed">
                  We adhere to cutting-edge innovation and tight standards in
                  our manufacturing processes to ensure the best quality
                  products.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-lufga text-[13px] lg:text-[14px] text-[#666666] leading-relaxed">
                  Our ISO & GMP certified facilities comply with international
                  standards and regulations for pharmaceutical manufacturing.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-lufga text-[13px] lg:text-[14px] text-[#666666] leading-relaxed">
                  Our expert team has comprehensive knowledge of the entire
                  pharmaceutical manufacturing lifecycle and best practices.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="font-lufga text-[13px] lg:text-[14px] text-[#666666] leading-relaxed">
                  With a turnaround time of fewer than 30 days, we ensure your
                  products reach market quickly without compromising quality.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-lufga text-[13px] lg:text-[14px] text-[#666666] leading-relaxed">
                  Manufacturing expertise across 500+ pharmaceutical products
                  including tablets, syrups, capsules, and more.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-lufga text-[13px] lg:text-[14px] text-[#666666] leading-relaxed">
                  We have successfully partnered with international and local
                  organizations to build successful pharmaceutical brands.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1366px] mx-auto px-4 lg:px-[75px]">
          <div className="bg-gradient-to-r from-[#8B1C52] to-[#6B1640] rounded-[20px] p-12 lg:p-16 text-center">
            <h2 className="font-regals text-[32px] lg:text-[42px] leading-[1.3] text-white mb-6">
              Ready to Start Your{" "}
              <span className="text-[#FFD6E8]">Manufacturing Journey?</span>
            </h2>
            <p className="font-lufga text-[14px] lg:text-[15px] text-white/90 max-w-2xl mx-auto mb-8">
              Partner with Biodermis Pharma for reliable, efficient, and
              high-quality pharmaceutical contract manufacturing services.
            </p>
        ...
        <div className="max-w-[1366px] mx-auto px-4 lg:px-[75px]">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="bg-white rounded-[15px] p-6 lg:p-8 hover:shadow-md transition-shadow duration-300"
              >
