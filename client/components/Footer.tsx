...
export default function Footer() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="font-lufga text-[15px] leading-[24px] mb-6">
                At Biodermis, we believe that healthy skin is the foundation of
                confidence. Rooted in science and inspired by nature, our
                mission is to provide high-quality skincare solutions that are
                gentle, effective, and tailored to real skin needs.
              </p>
  ...
  xmlns="http://www.w3.org/2000/svg"
>
  <path d="M18.244 2.25h3.308l-7.227 8.26L22.5 21.75h-6.49l-5.078-6.623-5.8 6.623H1.824l7.73-8.835L1.5 2.25h6.656l4.584 6.027 5.504-6.027Zm-1.161 17.52h1.833L7.152 4.126H5.187l11.896 15.644Z"/>
</svg>
                </a>
                <a
                  href="#"
  ...
  xmlns="http://www.w3.org/2000/svg"
>
  <path d="M12 2C6.486 2 2 6.486 2 12c0 4.237 2.69 7.844 6.48 9.243-.09-.784-.173-1.987.036-2.845.19-.814 1.23-5.18 1.23-5.18s-.314-.63-.314-1.562c0-1.463.848-2.555 1.903-2.555.897 0 1.33.673 1.33 1.48 0 .9-.573 2.246-.87 3.494-.247 1.045.524 1.897 1.552 1.897 1.862 0 3.296-1.964 3.296-4.796 0-2.507-1.8-4.26-4.368-4.26-2.97 0-4.712 2.228-4.712 4.53 0 .9.347 1.865.78 2.39a.315.315 0 01.073.302c-.08.333-.26 1.045-.296 1.19-.05.197-.16.24-.37.145-1.39-.646-2.26-2.674-2.26-4.303 0-3.504 2.545-6.723 7.335-6.723 3.85 0 6.845 2.743 6.845 6.41 0 3.823-2.41 6.903-5.76 6.903-1.125 0-2.18-.585-2.54-1.273l-.69 2.63c-.25.963-.93 2.17-1.38 2.91.94.29 1.94.45 2.98.45 5.514 0 10-4.486 10-10S17.514 2 12 2z"/>
</svg>
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M23.498 6.186a3.02 3.02 0 0 0-2.123-2.14C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.375.546a3.02 3.02 0 0 0-2.123 2.14C0 8.07 0 12 0 12s0 3.93.502 5.814a3.02 3.02 0 0 0 2.123 2.14C4.495 20.5 12 20.5 12 20.5s7.505 0 9.375-.546a3.02 3.02 0 0 0 2.123-2.14C24 15.93 24 12 24 12s0-3.93-.502-5.814ZM9.75 15.568V8.432L15.818 12 9.75 15.568Z"/>
  </svg>
                </a>
            ...
            {/* Quick Links */}
            <div>
              <h3 className="font-lufga text-[18px] font-bold mb-6">
                Quick links
              </h3>
            ...
            <div>
              ...
              <div className="space-y-4 font-lufga text-[15px]">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p><a href="tel:+919053777905" className="hover:underline">
    +91 90537-77905
  </a>
  <br />
  <a href="tel:+919053888905" className="hover:underline">
    +91 90538-88905
  </a></p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <p><a
    href="mailto:bioversalremedies@gmail.com"
    ...
    bioversalremedies@gmail.com
      ...
      <div className="border-t border-white/20 py-4">
        <div className="max-w-[1366px] mx-auto px-4 lg:px-[75px] flex flex-col md:flex-row justify-between items-center gap-2 font-lufga text-[14px]">
          ...
          <p>Developed By Bright World infotech</p>
        </div>
      </div>
    </footer>
  );
